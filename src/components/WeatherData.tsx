...
function WeatherData() {
  ...
  const currentWeatherCode = useAppSelector((state) => state.weatherData.current.weather_code)
	return (
		<div>
			<div className="today-weather bg-[url('/bg-today-small.svg')] sm:bg-[url('/bg-today-large.svg')] bg-no-repeat  h-[17.875rem] flex justify-between items-center bg-cover lg:p-12 rounded-16 max-w-full p-2">
