...
/* IMPORTANT: This function has a BAD name. It returns just a one-day name instead of all the days names */
export function getFullWeekDaysNamesStartingFromToday(isoDate: string) {
	/* 
...
export function getAbbreviatedWeekDaysNamesStartingFromToday(isoDate: string) {
	// todo
	// create dates Map
	// pass the input to the Date constructor
	const date = new Date(isoDate)
